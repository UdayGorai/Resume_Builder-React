...
const AuthButtonWithProvider = ({Icon , label, provider}) => {
  return (
    <div className="w-full px-4 py-3 rounded-md border-2 border-blue-500 flex items-center justify-between cursor-pointer group hover:bg-blue-500 active:scale-95 duration-150 hover:shadow-md">
